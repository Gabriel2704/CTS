...
public class Main {
	...
	public static void main(String[] args) {
		...
		Rezervare rezervare1 = new RezervareBuilder()
				.setCodRezervare(20).setArebauturaInclusa(true).build();
		
		Rezervare rezervare2 = new RezervareBuilder()
				.setCodRezervare(30).setAreMuzicaAmbientala(true).setGenMuzica("Pop").build();

		Rezervare rezervare3 = new Rezervare(false, true, false, false, null, 70);

		RezervareBuilder newBuilder = new RezervareBuilder()
				.setAreMancareInclusa(true).setArebauturaInclusa(true)
		...
		RezervareBuilderV2 newBuilderV2 = new RezervareBuilderV2()
				.setAreMancareInclusa(true).setAreBauturaInclusa(true)
				.setAreScaunErgonomic(true);
